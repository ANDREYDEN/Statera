      ...
      builder: (context, group) {
        ...
        final simpleItemFields = [
          FieldData<double>(
            id: 'item_value',
            label: 'Item Value',
            initialData: initialItemProperty(
              (SimpleItem i) => i.value,
              or: 0.0,
            ),
            ...
            (segmentValue, itemFields) => MapEntry(segmentValue, [
              ...
              if (canMarkForOthers)
                FieldData(
                  ...
                  initialData: initialAssigneeDecisions,
                  isAdvanced: true,
                ),
            ]),
          ),
